class Script(object):
    START_TXT = """<b>ʜᴇʏ {}, {}\n\nɪ ᴵ ᴬᴹ ᴬᵁᵀᴼᶠᴵᴸᵀᴱᴿ ᴮᴼᵀ. 𝐴𝐷𝐷 𝑀𝐸 𝐼𝑁 𝑌𝑂𝑈𝑅 𝐺𝑅𝑂𝑈𝑃 𝐴𝑁𝐷 𝑀𝐴𝐾𝐸 𝑀𝐸 𝐴𝑆 𝐴𝐷𝑀𝐼𝑁 𝑇𝑂 𝐺𝐸𝑇 𝐹𝐼𝐿𝐸𝑆"""

    HELP_TXT = "Hᴇʏ {}\nHᴇʀᴇ Mꜱ Mʏ Hᴇʟᴩ"

    ABOUT_TXT = """<b><blockquote>⍟[ ᴍʏ ᴅᴇᴛᴀɪʟꜱ ]⍟</blockquote>
 ‣ ᴍʏ ɴᴀᴍᴇ : <a href='https://t.me/{}'>{}</a>
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/moviesxyz_ofcl'>ᴍᴏᴠɪᴇsxʏᴢ™</a> 
 ...
 ‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ1.0 [sᴛᴀʙʟᴇ]</b>"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› : <a href='https://github.com/Aj22426/AutoFilter-Bot'>AᴜᴛᴏFɪʟᴛᴇʀ-Bᴏᴛ</a>

<b>ᴅᴇᴠ: <a href='https://t.me/moviesxyz_ofcl'>ᴍᴏᴠɪᴇsxʏᴢ™</a></b>"""
...
<b>Nᴏᴛᴇ:</b>
𝟷. Tᴇʟᴇɡʀᴀᴍ Wɪʟʟ Nᴏᴛ Aʟʟᴏᴡs Yᴏᴜ Tᴏ Sᴇɴᴅ Bᴜᴛᴛᴏɴs Wɪᴛʜᴏᴜᴛ Aɴʏ Cᴏɴᴛᴇɴᴛ, Sᴏ Cᴏɴᴛᴇɴᴛ Is Mᴀɴᴅᴀᴛᴏʀʏ.
𝟸. Tʜɪs Bᴏᴛ Sᴜᴘᴘᴏʀᴛs Bᴜᴛᴛᴏɴs Wɪᴛʜ Aɴʏ Tᴇʟᴇɡʀᴀᴍ Mᴇᴅɪᴀ Tʏᴘᴇ.
𝟹. Bᴜᴛᴛᴏɴs Sʜᴏᴜʟᴅ Bᴇ Pʀᴏᴘᴇʀʟʏ Pᴀʀsᴇᴅ As Mᴀʀᴋᴅᴏᴡɴ Fᴏʳᴍᴀᴛ
<b>Uʀʟ Bᴜᴛᴛᴏɴs:</b>
...
• /chats - Tᴏ Gᴇᴛ Lɪꜱᴛ Oꜙ Mʏ Cʜᴀᴛꜱ Aɴᴅ Iᴅꜱ
• /channel - Tᴏ Gᴇᴛ Lɪꜱᴛ Oꜙ Tᴏᴛᴀʟ Cᴏɴɴᴇᴄᴛᴇᴅ Cʜᴀɴɴᴇʟꜱ
...
• /disable - Wɪᴛʜ Cʜᴀᴛ Iᴅ Tᴏ Dᴇʟᴇᴛᴇ A Cʜᴀᴛ
...
• /clear_junk - Cʟᴇᴀʀ Aʟʟ Dᴇʟᴇᴛᴇᴅ Aᴄᴄᴏᴜɴᴛ & Bʟᴏᴄᴋᴇᴅ Aᴄᴄᴏᴜɴᴛ Iɴ Dᴀᴛᴀʙᴀsᴇ
• /clear_junk_group - Cʟᴇᴀʀ Aʟʟ Rᴇᴍᴏᴠᴇᴅ Gʀᴏᴜᴘs Oɴ Dᴀᴛᴀʙᴀsᴇ"""
...
◉ ʙʏ: @{}</b>"""
    ...
    GROUPMANAGER_TXT = """<b>Hᴇʟᴩ Fᴏʀ Gʀᴏᴜᴩ Mᴀɴᴀɢᴇʀ</b>
<i>Tʜɪꜱ Iꜱ Hᴇʟᴩ Oꜙ Yᴏᴜʀ Gʀᴏᴜᴩ Mᴀɴᴀɢɪɴɢ. Tʜɪꜱ Wɪʟʟ Wᴏʀᴋ Oɴʟʏ Fᴏʀ Gʀᴏᴜᴩ Aᴅᴍɪɴꜱ</i>
<b>Cᴏᴍᴍᴀɴᴅ & Uꜱᴀɢᴇ:</b>
• /inkick - Cᴏᴍᴍᴀɴᴅ Wɪᴛʜ Rᴇǫᴜɪʀᴇᴅ Aʀɡᴜᴍᴇɴᴛs Aɴᴅ I Wɪʟʟ Kɪᴄᴋ Mᴇᴍʙᴇʀs Fʀᴏᴍ Gʀᴏᴜᴘ.
• /instatus - Tᴏ Cʜᴇᴄᴋ Cᴜʀʀᴇɴᴛ Sᴛᴀᴛᴜs Oғ Cʜᴀᴛ Mᴇᴍʙᴇʀ Fʀᴏᴍ Gʀᴏᴜᴘ.
• /dkick - Tᴏ Kɪᴄᴋ Dᴇʟᴇᴛᴇᴅ Aᴄᴄᴏᴜɴᴛs
• /ban - Tᴏ Bᴀɴ A Uꜱᴇʀ Fᴏʀᴍ Tʜᴇ Gʀᴏᴜᴩ
• /unban - Uɴʙᴀɴ Tʜᴇ Bᴀɴɴᴇᴅ Uꜱᴇʀ
• /tban - Tᴇᴍᴩᴏʀᴀʀʏ Bᴀɴ A Uꜱᴇʀ
• /mute - Tᴏ Mᴜᴛᴇ A Uꜱᴇʀ
• /unmute - Tᴏ Uɴᴍᴜᴛᴇ Tʜᴇ Mᴜᴛᴇᴅ Uꜱᴇʀ
• /tmute - Wɪᴛʜ Vᴀʟᴜᴇ Tᴏ Mᴜᴛᴇ Uᴩ Tᴏ Pᴀʀᴛɪᴄᴜʟᴀʀ Tɪᴍᴇ Eɡ: <code>/tmute 2h</code> Tᴏ Mᴜᴛᴇ 2Hᴏᴜʀ Vᴀʟᴜᴇꜱ Iꜱ (m/h/d)
...
• /purge - Dᴇʟᴇᴛᴇ Aʟʟ Mᴇssᴀɢᴇs Fʀᴏᴍ Tʜᴇ Rᴇᴘʟɪᴇᴅ Tᴏ Mᴇssᴀɢᴇ, Tᴏ Tʜᴇ Cᴜʀʀᴇɴᴛ Mᴇssᴀɢᴇ """
    ...
    EXTRAMOD_TXT = """<b>Hᴇʟᴘ Fᴏʀ Exᴛʀᴀ Mᴏᴅᴜʟᴇ</b>
...
• /telegraph - Sᴇɴᴅ Mᴇ Tʜɪs Cᴏᴍᴍᴀɴᴅ Rᴇᴘʟʏ Wɪᴛʜ Pɪᴄᴛᴜʀᴇ Oʀ Vɪᴅᴇᴏ Uɴᴅᴇʀ (𝟻ᴍʙ)
...
• /share - Rᴇᴩʟʏ Wɪᴛʜ Tᴇxᴛ Tᴏ Gᴇᴛ Tᴇxᴛ Sʜᴀʀᴀʙʟᴇ Lɪɴᴋ
...
• /video [ʟɪɴᴋ] - Tᴏ Dᴏᴡɴʟᴏᴀᴅ Tʜᴇ YᴏᴜTᴜʙᴇ Vɪᴅᴇᴏ"""
    ...
    INPUT_REQUIRED = "❗ **Aʀɡᴜᴍᴇɴᴛ Rqᴜɪʀᴇᴅ**"

    KICKED = "✔️ Sᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ Kɪᴄᴋᴇᴅ {} Mᴇᴍʙᴇʀꜱ Acᴄᴏʀᴅɪɴɢ Tᴏ Tʜᴇ Aʀɡᴜᴍᴇɴᴛꜱ Prᴏᴠɪᴅᴇᴅ"
...
Fʀᴇᴇ Dɪꜱᴋ: {}"""
    ...
    FORCE_SUB_TEXT = "Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ Aɴᴅ Tʀʏ Aɢᴀɪɴ"
...
╰━━━━━━━━━━━━━━━➣"""
    ...
    RESULT_SHOWN = """⏰Result Shown in: {remaining_seconds} <i>seconds</i> 🔥
